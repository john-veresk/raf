is it possible to have multi select for raf do project picker so multiple project can be
runned?

---

merger. implement advance merger using harness. for example worktree merge happening when it's
not possible to merge automatically with git - raf should run claude / codex with instruction to
